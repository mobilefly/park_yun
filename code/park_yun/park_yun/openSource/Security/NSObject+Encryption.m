...
//    char (*keyPtr)[32] = keyPtr2;
    ...
    CCCryptorStatus cryptStatus = CCCrypt(kCCEncrypt, kCCAlgorithmAES128,
                                          kCCOptionPKCS7Padding/*这里就是刚才说道的PKCS7Padding填充了*/ | kCCOptionECBMode,
    ...
    if (cryptStatus == kCCSuccess) {
        return (NSData *)[NSData dataWithBytesNoCopy:buffer length:numBytesEncrypted];
    }
